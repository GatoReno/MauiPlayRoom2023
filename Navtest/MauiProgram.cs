...
using Navtest.Renders.PopupRender;
...
public static class MauiProgram
{
    public static MauiApp CreateMauiApp()
    {
        ...
        builder.Services.AddTransient<TestingPage>();
        builder.Services.AddTransient<TestingViewModel>();
        builder.Services.AddSingleton<ICustomePopupService, PopupService>();
